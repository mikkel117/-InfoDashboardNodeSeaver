...
startBus17 = async (t = 0) => {
    let bus17 = await( await fetch("http://xmlopen.rejseplanen.dk/bin/rest.exe/departureBoard?id=851973402&rttime&format=json&useBus=1")).json()
...
startOsthavnen = async (t = 0) => {
    ...
    let bus18 = await( await fetch("http://xmlopen.rejseplanen.dk/bin/rest.exe/departureBoard?id=851001703&rttime&format=json&useBus=1")).json()
    bus18 = await bus18.DepartureBoard.Departure
    let bus18modOst = []
